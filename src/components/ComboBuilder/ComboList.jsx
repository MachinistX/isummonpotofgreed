                ...
                {combos.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {combos.map(combo => {
                            ...
                            return (
                                <div key={combo.id} className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl flex justify-between items-center group relative hover:border-slate-600 transition-colors">
